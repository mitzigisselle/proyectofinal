...
<table  class="table table-sm dt-responsive nowrap table-bordered"  style="width:100%" id="tablaReporteAdminDataTable">
    <thead>
        <th>#</th>
        <th>Persona</th>
        <th>Dispositivo</th>
    ...
    <?php while($mostar = mysqli_fetch_array($respuesta)) {?>
        <tr>
            ...
            <td>
                ...
                onclick="obtenerDatosSolucion('<?php echo $mostar['idReporte'];?>')"
                data-toggle="modal" data-target="#modalAgregarSolucionReporte">Solucion</button>


                <?php echo $mostar ['solucion'];?>
            ...
            <td>
                <?php 
                   if ($mostar['solucion'] == "") {
                ?>
                    <button class="btn btn-danger btn-sm" onclick="eliminarReporteAdmin(<?php echo $mostar['idReporte'];?>)">
                         Eliminar
                    </button>
                <?php 
                } 
